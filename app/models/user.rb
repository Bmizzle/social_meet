class User < ActiveRecord::Base
  ...
  attr_accessible :username, :email, :password, :location, :gender, :birthday
  ...
  has_many :smeets, :dependent => :destroy
...
Smeet.find(:all, :conditions => ["user_id in (?)", friends.map(&:id).push(self.id)], :order => "created_at desc")
